...
Code History:
  SVN:     Max Hutchinson	mhutchin@psc.edu	(07/26/08) 
      (Added to SVN repository "HUTCH"; future changes will be logged there)

  Revised: Max Hutchinson	mhutchin@psc.edu	(07/24/08) 
      (Added co-variance matrix, task delays, and cleaned methods up)

  Revised: Max Hutchinson	mhutchin@psc.edu	(07/18/08) 
      (Expanded STOUT and FILE I/O, timers on all threads)
  Revised: Max Hutchinson	mhutchin@psc.edu	(07/18/08) 
      Bug fix: thread-local max change per step now checks all grid points)

  Revised: Max Hutchinson	mhutchin@psc.edu	(07/09/08) 
      (copy from t to tOld replaced with flipping points)

  Revised: Max Hutchinson	mhutchin@psc.edu	(06/23/08) 
      (inner-loop routines combined into "work", overhead cut)

  Written: Uriel Jaroslawski	uj07@cema.edu.ar 	(03/08/08)
           Jon Iturralde 	ji07@cema.edu.ar
*/
